        ...
        else
        {
            switch (str[0])
            {
                ...
                case '1':
                    ...
                    fseek(f,0,SEEK_END);
                    clk = time(NULL);
                    fprintf(f,"MASTER: konsole (PID = %d) created at : %s", pid1, ctime(&clk));
                    fflush(f);
                ...
                case '2':
                    ...
                    fseek(f,0,SEEK_END);
                    clk = time(NULL);
                    fprintf(f,"MASTER: konsole (PID = %d) created at : %s", pid2, ctime(&clk));
                    fflush(f);
                    ...
                    fseek(f,0,SEEK_END);
                    clk = time(NULL);
                    fprintf(f,"MASTER: konsole (PID = %d) created at : %s", pid6, ctime(&clk));
                    fflush(f);
                ...
                case '3':
                    ...
                    fseek(f,0,SEEK_END);
                    clk = time(NULL);
                    fprintf(f,"MASTER: konsole (PID = %d) created at : %s", pid3, ctime(&clk));
                    fflush(f);
                    ...
                    fseek(f,0,SEEK_END);
                    clk = time(NULL);
                    fprintf(f,"MASTER: konsole (PID = %d) created at : %s", pid7, ctime(&clk));
                    fflush(f);
                ...
                case '4':
                    ...
                    fseek(f,0,SEEK_END);
                    clk = time(NULL);
                    fprintf(f,"MASTER: konsole (PID = %d) created at : %s", pid4, ctime(&clk));
                    fflush(f);
                    ...
                    fseek(f,0,SEEK_END);
                    clk = time(NULL);
                    fprintf(f,"MASTER: konsole (PID = %d) created at : %s", pid8, ctime(&clk));
                    fflush(f);
